...
<?php endif; ?> 
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form action="<?php echo e(route('users.store')); ?>" method="POST" name="userForm" id="userFormId" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
            <div class="row"> 
              <!-- Form controls -->  
              <div class="col-md-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/allianze/Projects/eoffice-2025/eoffice/resources/views/users/create.blade.php ENDPATH**/ ?>