...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="<?php echo e(route('branchs.index')); ?>" class="menu-link">
  ...
  <!-- / Menu --><?php /**PATH /home/allianze/Projects/eoffice-2025/eoffice/resources/views/components/menu.blade.php ENDPATH**/ ?>