...
class Employee extends Model
{
    ...
    protected $fillable= [
        ...
        'role','status','resigned_date','login_limited_time','open_work_status','open_work_setdate','appointment_status','team_lead','bank_name','bank_branch','beneficiary_name','ifsc',
        'account_number'
