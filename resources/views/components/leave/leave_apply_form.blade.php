...
<div class="card mb-4">
  <form id="leaveForm" class="card-body" method="post" action="{{ route('leaves.store') }}">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-12">
        <label class="form-label" for="leave-editor">Leave Reason</label>
        <input type="hidden" id="reason" name="reason" value="{{ strip_tags(old('reason')) }}">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-4">
        <div class="form-check">
          <input name="leave_type" class="form-check-input" type="radio" value="full_day" id="defaultRadio1" {{ old('leave_type') == 'full_day' ? 'checked' : '' }} />
      ...
      <div class="col-md-4">
        <div class="form-check">
          <input name="leave_type" class="form-check-input" type="radio" value="half_day" id="defaultRadio2" {{ old('leave_type', 'half_day') == 'half_day' ? 'checked' : '' }} />
      ...
      <div class="col-md-4">
        <div class="form-check">
          <input name="leave_type" class="form-check-input" type="radio" value="off_day" id="defaultRadio3" {{ old('leave_type') == 'off_day' ? 'checked' : '' }} />
