...
<form action="{{ route('job.store') }}" method="POST" id="job_form" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-sm-12 mb-3">
            <div class="form-group">
                ...
                <div id="job_description_editor"></div>
                <input type="hidden" name="job_description" value="{{ strip_tags(old('job_description')) }}" id="job_description">
            </div>
        </div>
