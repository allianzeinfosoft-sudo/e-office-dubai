                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-end mb-3">
                            <a class="btn add-new btn-primary" href="javascript:void(0);" onclick="openBannerOffcanvas()">
                                <span>
...
<script>
    // form validation
    var quillBannerEditor1 = new Quill('#banner-editor', { theme: 'snow',
    ...
    $(function() {
        ...
        if (bannerTable.length) {
            ...
            bannerTable.DataTable({
                ajax: {
                    type: "GET",
                    url: "{{ route('banner.index') }}", // Fixed syntax
                    dataType: "json",
                    dataSrc: "data"
                },
                columns: [
                    ...
                    { data: 'banner_title', title: 'Title' },
                    { data: 'banner_detatils', title: 'Details' },
                    ...
                    { data: 'created_at', title: 'Create Date'},
                    {
                        ...
                        render: function (data, type, row, full) {
                            const editUrl = "{{ route('banner.edit', ':id') }}".replace(':id', row.id);
                            return `
                                <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-primary edit-banner" onclick="openBannerOffcanvas(${row.id})"><i class="ti ti-edit"></i></a>
