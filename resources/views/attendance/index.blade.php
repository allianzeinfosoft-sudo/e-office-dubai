    ...
    <div class="row">
          <form id="customMarkingForm" action="{{ route('attendance.custom-mark-in') }}" method="post">
            ...
            <div class="col-12 mb-3">
              ...
              <input type="time" id="signin_time" name="signin_time" class="form-control" value="{{ \Carbon\Carbon::now(config('app.timezone'))->format('H:i') }}"  placeholder="Time" />
      ...
      <form id="emergencyMarkingForm" action="{{ route('attendance.emergency-mark') }}" method="post">
        @csrf
            ...
            <div class="col-12 mb-3">
              ...
              <input type="time" id="time_in_out" name="time_in_out" class="form-control" value="{{ \Carbon\Carbon::now(config('app.timezone'))->format('H:i') }}" placeholder="Time" />
            </div>
          </form>
        </div>
        <div class="col-sm-12 d-flex justify-content-end align-items-center gap-2">
