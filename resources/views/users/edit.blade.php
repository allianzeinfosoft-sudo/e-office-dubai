      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" name="userForm" id="userFormId"
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="row card-body">
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="employeeID" id="employeeID"
                            value="{{ $user->employee?->employeeID ?? '' }}" placeholder="Enter username"
                            aria-describedby="employeeID" readonly />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="full_name" name="full_name"
                            value="{{ old('full_name', $user->employee?->full_name) ?? ''  }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="phonenumber" name="phonenumber"
                            value="{{ old('phonenumber', $user->employee?->phonenumber) ?? ''  }}"
                            placeholder="Enter phone number" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="reporting_to" class="form-label">Reporting To:</label>
                        <select id="reporting_to" name="reporting_to" class="select2 form-select form-select-lg"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="email" class="form-control" id="personal_email" name="personal_email"
                            value="{{ old('personal_email', $user->employee?->personal_email) }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="blood_group" name="blood_group" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="qualification" name="qualification"
                            value="{{ old('qualification', $user->employee?->qualification) }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="esi_no" name="esi_no"
                            value="{{ old('esi_no', $user->employee?->esi_no) ?? '' }}" placeholder="Enter ESI No" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="aadhaar" name="aadhaar"
                            value="{{ old('aadhar', $user->employee?->aadhaar) ?? '' }}" placeholder="Enter Aadhaar No" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="pf_no" name="pf_no"
                            value="{{ old('pf_no', $user->employee?->pf_no) ?? '' }}" placeholder="Enter PF No" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="electoral_id" class="form-label">Electoral ID:</label>
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="electoral_id" name="electoral_id"
                            value="{{ old('electoral_id', $user->employee?->electoral_id) }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" id="pan" name="pan"
                            value="{{ old('pan', $user->employee?->pan) ?? '' }}" placeholder="Enter PAN" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="date" class="form-control" id="dob" name="dob"
                            value="{{ old('dob', $user->employee?->dob) ?? '' }}" placeholder="Enter Date of Birth" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="group" class="form-label">Group:</label>
                        <select id="group" name="group" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                          <option value="">Select Group</option>
                          @foreach ($roles as $role)
                            <option value="{{ $role->name }}" {{ old('group', $user->employee?->group) == $role->name ? 'selected' : '' }}>
                              {{ $role->name }}
                            </option>
                          @endforeach
                        </select>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <textarea type="text" class="form-control" id="address" name="address"
                            placeholder="Select Address" rows="3">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mt-3 d-flex justify-content-center align-items-center"
                        style="background-color: #625acc; height: 200px;">
                        <img id="imagePreview" src="{{ asset('storage/' . $user->employee?->profile_image ?? '') }}"
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="mobile_relationship" id="mobile_relationship"
                            value="{{ old('mobile_relationship', $user->employee?->mobile_relationship) ?? ''}}"
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="landline" id="landline"
                            value="{{ old('landline', $user->employee?->landline) ?? '' }}"
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="landline_relationship" id="landline_relationship"
                            value="{{ old('landline_relationship', $user->employee?->landline_relationship) ?? '' }}"
                            placeholder="Enter relationship" />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="row card-body">
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="department_id" name="department_id" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="designation_id" name="designation_id" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                          @foreach ($designations as $value)
                            <option value="{{ $value->id }}" {{ old('designation_id', $user->employee?->designation_id) == $value->id ? 'selected' : '' }}>
                              {{ $value->designation ?? 'N/A' }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input class="form-control" type="date" id="join_date" name="join_date"
                            value="{{ $user->employee?->join_date ?? '0' }}" />
                        </div>
                      </div>

                      <div class="col-md-4 mb-3">
                        <label for="shift_id" class="form-label">Shift No:</label>
                        <select id="shift_id" name="shift_id" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                          <option value="">Select Shift</option>
                          @foreach ($work_shifts as $work_shift)
                            <option value="{{  $work_shift->id ?? '' }}"
                              data-login_limit="{{ $work_shift->login_limited_time ?? '' }}" {{ old('shift_id', $user->employee?->shift_id) == $work_shift->id ? 'selected' : '' }}>
                              {{  $work_shift->shift_id ?? '' }} </option>
                          @endforeach
                        </select>
                      </div>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="time" class="form-control" id="login_limited_time" step="1"
                            name="login_limited_time"
                            value="{{ old('login_limited_time', $user->employee?->login_limited_time) ?? '' }}"
                            placeholder="Enter login limited time">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="role" name="role" class="select2 form-select form-select-lg" data-allow-clear="true">
                          ...
                          @foreach ($positions as $position)
                            <option value="{{ $position->position_name }}" {{ old('role', $user->employee?->role) == $position->position_name ? 'selected' : '' }}>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="holidayGroup" name="holidayGroup" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="status" name="status" class="select2 form-select form-select-lg"
                          ...
                          @foreach ($user_statuses as $user_status)
                            <option value="{{ $user_status->id }}" {{ old('status', $user->employee?->status) == $user_status->id ? 'selected' : '' }}>
                              {{ $user_status->status_name ?? '' }} </option>
                          @endforeach
                        </select>
                      </div>

                      <div class="col-md-4 mb-3" id="resigned_date_container" style="display: none;">
                        <label for="resigned_date" class="form-label">Resigned Date:<span
                            class="mandatory">*</span></label>
                        <input type="date" class="form-control"
                          value="{{ old('resigned_date', $user->employee?->resigned_date) ?? '' }}" id="resigned_date"
                          name="resigned_date" placeholder="Enter resigned date">
                      </div>

                      {{-- <div class="col-md-4 mb-3">
                        <label for="leave_carry_info" class="form-label">Leave Carry Info:</label>
                        <div class="input-group input-group-merge">
                          <input id="leave_carry_info" name="leave_carry_info" class="form-control" type="text"
                            value="{{ old('leave_carry_info', $user->employee?->leave_carry_info) ?? '' }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select id="appointment_status" name="appointment_status"
                          ...
                          @foreach (['probation', 'confirmed'] as $appointment_status)
                            <option value="{{ $appointment_status }}" {{ old('appointment', $user->employee?->appointment_status) == $appointment_status ? 'selected' : '' }}>
                              {{ $appointment_status }} </option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="team_lead" class="form-label">Team Lead:</label>
                        <select id="team_lead" name="team_lead" class="select2 form-select form-select-lg"
                          data-allow-clear="true">
                          <option selected value="">Please select</option>
                          @foreach ($employees as $employee)
                            <option value="{{ $employee->user_id ?? '' }}" {{ old('team_lead', $user->employee?->team_lead) == $employee->user_id ? 'selected' : '' }}>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="bank_name" id="bank_name"
                            value="{{ old('bank_name', $user->employee?->bank_name) ?? '' }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="bank_branch" id="bank_branch"
                            value="{{ old('bank_branch', $user->employee?->bank_branch) ?? '' }}"
                            placeholder="Enter bank_branch" />
                        </div>
                      </div>
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="beneficiary_name" id="beneficiary_name"
                            value="{{ old('beneficiary_name', $user->employee?->beneficiary_name) ?? '' }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="account_number" id="account_number"
                            value="{{ old('account_number', $user->employee?->account_number) ?? '' }}"
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="text" class="form-control" name="ifsc" id="ifsc"
                            value="{{ old('ifsc', $user->employee?->ifsc) ?? '' }}" placeholder="Enter IFSC" />
                        </div>
                      </div>
                    </div>
                  </div>
