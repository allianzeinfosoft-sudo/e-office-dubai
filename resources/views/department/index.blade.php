                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-end mb-3">
                            <a class="btn add-new btn-primary" href="javascript:void(0);"
                                onclick="openDepartmentOffcanvas()">
                                <span>
                    ...
                    <div class="card">
                        <div class="card-datatable table-responsive">
                            <table
                                class="hover_effect datatables-basic datatables-department table border-top table-stripedc"
                                id="datatables-department">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
...
<!-- Add Banner -->
<div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="department_offcanvas"
