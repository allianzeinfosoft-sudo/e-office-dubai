        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">e-Library /</span> Pending Report</h4>
                    ...
                    <div class="card">
                        <div class="card-datatable">
                            <table class="table table-striped" id="pendingReportTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Book</th>
...
<script>
$(function () {
    const table = $('#pendingReportTable').DataTable({
        dom: 'Bfrtip',
        buttons: [
            { extend: 'excelHtml5', title: 'Pending Books Report' },
            { extend: 'pdfHtml5', title: 'Pending Books Report', orientation: 'portrait', pageSize: 'A4' },
            { extend: 'print', title: 'Pending Books Report' }
        ],
        processing: false,
        serverSide: false,
        ajax: {
            url: "{{ route('e-library.reports.pending-report-data') }}",
            data: function (d) {
