...
<body>
    ...
    <h2>Self Appraisal Report</h2>

    <div class="section">
        <p class="info-row">
            <strong>Employee Name:</strong> {{ $sar_info->employee->full_name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Department:</strong> {{ $sar_info->employee->department->name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Designation:</strong> {{ $sar_info->employee->designation->name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Created By:</strong> {{ $sar_info->template->creator->full_name ?? 'N/A' }}
        </p>
    </div>
