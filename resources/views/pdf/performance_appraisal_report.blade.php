...
<body>
    ...
    <div class="section">
        <p class="info-row">
            <strong>Employee Name:</strong> {{ $par_info->employee->full_name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Department:</strong> {{ $par_info->employee->department->name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Designation:</strong> {{ $par_info->employee->designation->name ?? 'N/A' }} &nbsp; | &nbsp;
            <strong>Created By:</strong> {{ $par_info->template->creator->full_name ?? 'N/A' }}
        </p>
    </div>
