                                    ...
                                    <form id="fullDayAttendanceForm" action="{{ route('attendance.full-day-attendance-entry') }}" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-3 mb-3">
                                                ...
                                                <input type="time" id="signout_time" name="signout_time" class="form-control" value=""  placeholder="Time" />
                                            </div>

                                            <div class="col-3 mb-3">
                                                <label for="working_hours" class="form-label">Working Hours</label>
                                                <input type="time" id="working_hours" name="working_hours" class="form-control" value=""  placeholder="Time" />
                                            </div>
