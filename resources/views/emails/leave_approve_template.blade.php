...
<head>
    <meta charset="UTF-8">
    <title>Your Leave Application Is Approved</title>
</head>
<body>
    <p>Dear,</p>
    ...
    <p>Your leave for the period from <strong>{{ $details['start_date'] }}</strong> to <strong>{{ $details['end_date'] }}</strong> due to {{ $details['leave_reason'] }} is sanctioned and taken on record accordingly.</p>
