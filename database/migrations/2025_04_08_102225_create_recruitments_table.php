...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('recruitments', function (Blueprint $table) {
            ...
            $table->integer('porjectId')->nullable();
            $table->integer('shiftId')->nullable();
            $table->string('salartyRage', 100)->nullable();
            ...
            $table->string('schoolinMedium',100)->nullable();        
            ...
            $table->integer('requierToAndFroCharge')->nullable()->comment('0 = No, 1 = Yes, 2 = Not Applicable')->default(0);
